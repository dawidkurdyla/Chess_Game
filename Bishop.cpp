...
Bishop::Bishop(Team team, Position pos) : Figure(team, pos, Piece_Type::BISHOP)
{
	std::string filepath;

	if (team == Team::WHITE)
		filepath = "images/W_Bishop.png";

	else if (team == Team::BLACK)
		filepath = "images/B_Bishop.png";
...
void Bishop::calculatePossibleMoves(Figure* arena[8][8], bool testCheck)
{
