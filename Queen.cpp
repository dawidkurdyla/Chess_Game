...
-------------------------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------------------------
		Plik zawiera definicjê metod klasy Queen
-------------------------------------------------------------------------------------------*/


#include "Queen.h"

Queen::Queen(Team team, Position pos) : Figure(team, pos, Piece_Type::QUEEN)
{
	std::string filepath;

	if (team == Team::WHITE)
		filepath = "images/W_Queen.png";

	else if (team == Team::BLACK)
		filepath = "images/B_Queen.png";
...
void Queen::calculatePossibleMoves(Figure* arena[8][8], bool testCheck)
{
